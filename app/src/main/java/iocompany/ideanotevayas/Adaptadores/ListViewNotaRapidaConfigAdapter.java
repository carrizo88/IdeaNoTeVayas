...
public class ListViewNotaRapidaConfigAdapter extends BaseAdapter {
    private Context context;
    private int layout;
    private List<String> lista;
    private boolean switch1;

    public ListViewNotaRapidaConfigAdapter(Context context,int layout, List<String> lista  ){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            holder.NotaRapidaConfigTextView=(TextView)convertView.findViewById(R.id.textViewListViewNotaRapidaConfig);
            //holder.SwitchNotaRapida=(Switch)convertView.findViewById(R.id.switchNotaRapidaConfig);
            holder.textViewListViewNotaRapidaConfig2=(TextView)convertView.findViewById(R.id.textViewListViewNotaRapidaConfig2);
        ...
        holder.NotaRapidaConfigTextView.setText(currentName);
        holder.textViewListViewNotaRapidaConfig2.setText("Establecer Movimiento para Nota Rapida");
    ...
    static class ViewHolder{
        private TextView NotaRapidaConfigTextView;
        private Switch SwitchNotaRapida;
        private TextView textViewListViewNotaRapidaConfig2;
    }
}
